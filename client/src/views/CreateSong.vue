<template>
  <div class="mt-5">
    <v-container>
      ...
      <v-row>
        <v-col cols="12">
          <v-text-field v-model="song.title" label="Title" required></v-text-field>
        </v-col>
        <v-col cols="12">
          <v-text-field v-model="song.artist" label="Artist" required></v-text-field>
        </v-col>
        <v-col cols="12">
          <v-text-field v-model="song.genre" label="Genre" required></v-text-field>
        </v-col>
        <v-col cols="12">
